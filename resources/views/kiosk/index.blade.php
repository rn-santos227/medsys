                                    ...
                                    <div class="row mt-2">
                                        <div class="col-md-2">
                                            <div class="progress mt-2">
                                                <div class="progress-bar bg-success" role="progressbar" style="width: 100%" aria-valuenow="{{ $dispenser->quantity }}" aria-valuemin="0" aria-valuemax="{{ $dispenser->quanitity }}"></div>
                                            </div>
                                        </div>
